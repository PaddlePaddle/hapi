...
class ProgressBar(object):
    ...
    def __init__(self, num=None, width=50, start=True, file=sys.stdout):
        self._num = num
        ...
        self._dynamic_display = ((hasattr(self.file, 'isatty') and
                                  self.file.isatty()) or
    ...
    def update(self, current_num, values=None):
        ...
        if self._num is not None:
          ...
          bar_chars = ('%' + str(numdigits) + 'd/%d [') % (current_num, self._num)
          ...
          bar_chars = '%7d/Unknown' % current_num
